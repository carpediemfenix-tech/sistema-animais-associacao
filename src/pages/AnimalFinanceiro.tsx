  ...
  const loadRelatedData = async () => {
    try {
      ...
      const { data: movimentosData, error: movimentosError } = await supabase
        .from('movimentos_financeiros') // 🆕 DEFINITIVO: tabela recriada com estrutura correta
        .select(`
          *,
      ...
      const { data: categoriasData, error: categoriasError } = await supabase
        .from('categorias_financeiras') // 🆕 DEFINITIVO: tabela recriada com estrutura correta
        .select('*')
