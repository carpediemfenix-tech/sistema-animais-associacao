-- Dados Iniciais Corrigidos para Sistema de Agenda e Calendário
...
-- 2. Inserir Eventos de Exemplo (sem referências específicas a animais)
...
('Consulta Veterinária - Rotina', 'Consulta de rotina para animal', 
...
('Cirurgia - Castração', 'Procedimento de castração', 
...
-- Turnos adicionais
('Turno Limpeza Semanal', 'Limpeza profunda semanal', 
 (SELECT id FROM tipos_eventos_2025_12_11_03_00 WHERE nome = 'Turno Limpeza' LIMIT 1),
 '2025-12-17 09:00:00+00', '2025-12-17 12:00:00+00', 
 'Todas as Instalações', 'agendado', 'normal', 'Limpeza completa de casotas e áreas comuns'),

('Turno Passeios', 'Turno de passeios com os cães', 
 (SELECT id FROM tipos_eventos_2025_12_11_03_00 WHERE nome = 'Turno Passeio' LIMIT 1),
 '2025-12-18 15:00:00+00', '2025-12-18 16:30:00+00', 
 'Parque Adjacente', 'agendado', 'normal', 'Priorizar cães de grande porte');

-- 3. Inserir Turnos de Voluntários (sem referências específicas)
INSERT INTO turnos_voluntarios_2025_12_11_03_00 (
  evento_id, funcao, local_turno, hora_inicio, hora_fim, duracao_minutos
) VALUES
...
((SELECT id FROM eventos_agenda_2025_12_11_03_00 WHERE titulo = 'Turno Limpeza Semanal' LIMIT 1),
 'limpeza', 'instalacoes', '09:00', '12:00', 180),

((SELECT id FROM eventos_agenda_2025_12_11_03_00 WHERE titulo = 'Turno Passeios' LIMIT 1),
 'passeio', 'parque', '15:00', '16:30', 90);

-- 4. Inserir Lembretes Automáticos
...
-- Lembrete para consulta
((SELECT id FROM eventos_agenda_2025_12_11_03_00 WHERE titulo = 'Consulta Veterinária - Rotina' LIMIT 1),
 'email', 60, '2025-12-12 08:00:00+00',
 'Lembrete: Consulta Veterinária',
 'Lembrete: A consulta veterinária está agendada para hoje às 09:00 na Clínica Veterinária Central. Não esquecer o cartão de vacinação.',
 'consulta_veterinaria'),

-- Lembrete para cirurgia
((SELECT id FROM eventos_agenda_2025_12_11_03_00 WHERE titulo = 'Cirurgia - Castração' LIMIT 1),
 'email', 720, '2025-12-13 02:00:00+00',
 'Lembrete: Preparação para Cirurgia',
 'Lembrete: Cirurgia agendada para amanhã às 14:00. Iniciar jejum às 02:00 (12 horas antes).',
 'preparacao_cirurgia'),
...
-- Lembrete para evento
((SELECT id FROM eventos_agenda_2025_12_11_03_00 WHERE titulo = 'Evento Adoção Dezembro' LIMIT 1),
 'email', 1440, '2025-12-13 10:00:00+00',
 'Lembrete: Evento de Adoção Amanhã',
 'Lembrete: O evento de adoção é amanhã das 10:00 às 18:00 no Parque Municipal. Preparar 20 animais.',
 'evento_especial');
...
-- 6. Criar função para gerar relatórios automáticos
...
BEGIN
  ...
  JOIN eventos_agenda_2025_12_11_03_00 e ON tv.evento_id = e.id
  WHERE DATE(e.data_inicio) BETWEEN p_data_inicio AND p_data_fim
    AND tv.voluntario_id IS NOT NULL;
