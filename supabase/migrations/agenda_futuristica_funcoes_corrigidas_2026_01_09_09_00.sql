-- FUNÇÕES RPC PARA AGENDA FUTURÍSTICA (CORRIGIDAS)
...
-- Função para obter eventos por período (corrigida)
...
BEGIN
  ...
  WHERE 
    DATE(e.data_evento) BETWEEN data_inicio AND data_fim_periodo
