-- Criar tabela eventos_animal se não existir, ou adicionar campos em falta
CREATE TABLE IF NOT EXISTS public.eventos_animal (
    ...
    tipo_evento_id INTEGER NOT NULL REFERENCES public.tipos_eventos(id),
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE public.eventos_animal ADD COLUMN responsavel_id UUID REFERENCES public.voluntarios(id);
    END IF;
