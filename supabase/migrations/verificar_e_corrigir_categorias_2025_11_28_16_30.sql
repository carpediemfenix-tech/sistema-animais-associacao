...
SELECT 'Verificando tabela categorias_financeiras' as status;

-- Contar registros existentes
SELECT COUNT(*) as total_categorias FROM categorias_financeiras;

-- Mostrar algumas categorias se existirem
SELECT id, nome, tipo, escopo, ativo FROM categorias_financeiras LIMIT 5;
...
SELECT COUNT(*) as categorias_inseridas FROM categorias_financeiras;
