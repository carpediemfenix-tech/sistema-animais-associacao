-- =====================================================
-- FASE 2: SISTEMA DE STOCK INTELIGENTE - APROVISIONAMENTO
-- =====================================================
...
CREATE TABLE IF NOT EXISTS public.movimentos_stock_2026_01_06 (
    ...
    -- Relacionamentos opcionais (dependendo do tipo de movimento)
    voluntario_id UUID REFERENCES public.voluntarios(id), -- Se atribuído a voluntário
    animal_id UUID REFERENCES public.animais_2025_12_18_14_15(id), -- Se atribuído a animal
    missao_id UUID REFERENCES public.missoes_2025_12_18_14_15(id), -- Se atribuído a missão
...
-- Blusões XXL (exemplo do usuário)
...
SELECT public.atualizar_stock_item(
    ...
    'SAIDA_ATRIBUICAO',
    1,
    'Atribuído a voluntário para missão',
    NULL,
    NULL,
    (SELECT id FROM public.voluntarios LIMIT 1)
) as teste_saida;