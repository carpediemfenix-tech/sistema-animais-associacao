-- Primeiro, vamos verificar se existem missões na tabela e inserir algumas
...
(
  ...
  'e1a980f8-09ed-434e-b838-6a86fb2d24a6', -- Usar o próprio voluntário como responsável
  NOW(),
  NOW()
),
(
