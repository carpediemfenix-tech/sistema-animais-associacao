-- =====================================================
-- MELHORIAS CORRIGIDAS NO SISTEMA DE ATRIBUIÇÕES
...
-- 4. Função melhorada para processar devolução (agora suporta devolução parcial)
...
BEGIN
    ...
    -- Registrar estado do item se a tabela existir
    ...
    ON CONFLICT DO NOTHING; -- Ignorar se a tabela não existir
...
-- 5. Atualizar dados existentes para incluir quantidade_restante
UPDATE public.atribuicoes_itens_2026_01_07_00_52 
SET 
...
-- 6. Atualizar configurações existentes para incluir grupos
UPDATE public.config_atribuicoes_2026_01_07_00_52 
SET permite_grupos = true 
WHERE permite_grupos IS NULL;

-- 7. Inserir configurações padrão para grupos nas categorias existentes
