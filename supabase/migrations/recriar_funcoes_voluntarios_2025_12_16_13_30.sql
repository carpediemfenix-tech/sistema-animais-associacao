-- ========================================
-- CORREÇÃO URGENTE - RECRIAR FUNÇÕES DE VOLUNTÁRIOS
-- ========================================

-- Remover funções existentes
DROP FUNCTION IF EXISTS buscar_voluntarios(TEXT);
DROP FUNCTION IF EXISTS obter_voluntario_display(UUID);

-- Recriar função buscar_voluntarios com tipos corretos
...
-- Recriar função obter_voluntario_display
...
SELECT 'Funções de voluntários recriadas com sucesso!' as status;